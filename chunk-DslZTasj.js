...
`],encapsulation:2})}return c})();function Ft(c,s){if(c&1){let e=aT();ja(0,"mat-form-field",3)(1,"input",4),ly("ngModelChange",function(n){Vp(e);let o=fT();return GT(o.todoText,n)||(o.todoText=n),$p(n)}),nf(),Gb(),nf(),ja(2,"div",5)(3,"button",6),ec("click",function(){Vp(e);let n=fT();return $p(n.updateTodo())}),ja(4,"mat-icon"),HT(5,"check"),nf()(),ja(6,"button",6),ec("click",function(){Vp(e);let n=fT();return $p(n.toggleEditMode())}),ja(7,"mat-icon"),HT(8,"close"),nf()()();}if(c&2){let e=fT();nb(),uy("ngModel",e.todoText),qb();}}function Dt(c,s){if(c&1){let e=aT();ja(0,"span"),HT(1),nf(),ja(2,"div",5)(3,"button",6),ec("click",function(){Vp(e);let n=fT();return $p(n.toggleEditMode())}),ja(4,"mat-icon"),HT(5,"edit"),nf()(),ja(6,"button",6),ec("click",function(){Vp(e);let n=fT();return $p(n.deleteTodo())}),ja(7,"mat-icon"),HT(8,"delete"),nf()()();}if(c&2){let e=fT();nb(),cy(e.todo().text);}}var se=class c{todoService=p(Tt$1);activatedRoute=p(rn);todo=ic({});isEditMode=Z(false);todoText=Z("");currentDate=this.activatedRoute.snapshot.params.date;handleCheckboxChange=s=>{this.todoService.updateTodo(F(m({},this.todo()),{isDone:s}),this.currentDate);};toggleEditMode=()=>{this.todoText.update(()=>this.todo().text),this.isEditMode.update(s=>!s);};updateTodo=()=>{this.todoService.updateTodo(F(m({},this.todo()),{text:this.todoText()}),this.currentDate),this.toggleEditMode();};deleteTodo=()=>{this.todoService.deleteTodo(this.todo().id,this.currentDate);};static \u0275fac=function(e){return new(e||c)};static \u0275cmp=Zt({type:c,selectors:[["app-todo"]],inputs:{todo:[1,"todo"]},decls:5,vars:2,consts:[[1,"todo"],[3,"change","checked"],[1,"todo-field"],["subscriptSizing","dynamic","appearance","outline",1,"todo-input"],["matInput","","type","text",3,"ngModelChange","ngModel"],[1,"todos-controls"],["matIconButton","",3,"click"]],template:function(e,t){e&1&&(ja(0,"div",0)(1,"mat-checkbox",1),ec("change",function(o){return t.handleCheckboxChange(o.checked)}),nf(),ja(2,"div",2),QC(3,Ft,9,1)(4,Dt,9,1),nf()()),e&2&&(nb(),Gv("checked",t.todo().isDone),nb(2),XC(t.isEditMode()?3:4));},dependencies:[rt,$n,Ho,Ar,Wt,Vr,hn,V,re],styles:[".todo[_ngcontent-%COMP%]{display:flex;gap:16px;align-items:center;width:100%;padding:8px;border:1px solid var(--mat-sys-outline);border-radius:var(--mat-sys-corner-small)}.todo-field[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:space-between;width:100%;gap:16px;--mat-form-field-container-vertical-padding: 4px;--mat-form-field-container-height: 32px}.todo-input[_ngcontent-%COMP%]{flex:1}"]})};function At(c,s){if(c&1&&Ja(0,"app-todo",13),c&2){let e=fT().$implicit;Gv("todo",e);}}function Rt(c,s){if(c&1&&QC(0,At,1,1,"app-todo",13),c&2){let e=s.$implicit;XC(e.isDone?-1:0);}}function Nt(c,s){c&1&&(ja(0,"span"),HT(1,"\u041D\u0435\u0442 \u0430\u043A\u0442\u0438\u0432\u043D\u044B\u0445 \u0437\u0430\u0434\u0430\u0447"),nf());}function Lt(c,s){if(c&1&&Ja(0,"app-todo",13),c&2){let e=fT().$implicit;Gv("todo",e);}}function zt(c,s){if(c&1&&QC(0,Lt,1,1,"app-todo",13),c&2){let e=s.$implicit;XC(e.isDone?0:-1);}}function Pt(c,s){c&1&&HT(0," \u041D\u0435\u0442 \u0437\u0430\u0432\u0435\u0440\u0448\u0435\u043D\u043D\u044B\u0445 \u0437\u0430\u0434\u0430\u0447 ");}var de=class c{todoService=p(Tt$1);activatedRoute=p(rn);currentDate=this.activatedRoute.snapshot.params.date;newTodo=Z("");searchTodo=Z("");todos=nc(()=>this.todoService.todos()[this.currentDate]?.filter(s=>this.searchTodo()?s.text.toLocaleLowerCase().includes(this.searchTodo().toLocaleLowerCase()):true));activeTodos=nc(()=>this.todos()?.filter(s=>!s.isDone));completedTodos=nc(()=>this.todos()?.filter(s=>s.isDone));addTodo=()=>{this.todoService.addTodo(this.newTodo(),this.currentDate),this.newTodo.update(()=>"");};routesList=iG;static \u0275fac=function(e){return new(e||c)};static \u0275cmp=Zt({type:c,selectors:[["app-todos"]],decls:37,vars:10,consts:[[1,"todos"],[1,"todos-header"],[1,"todos-title"],["matButton","filled",1,"back-link",3,"routerLink"],[1,"todos-controls"],[1,"create-todo"],["appearance","outline","subscriptSizing","dynamic",1,"todo-input"],["matInput","","type","text","placeholder","\u0422\u0435\u043A\u0441\u0442 \u0437\u0430\u0434\u0430\u0447\u0438",3,"ngModelChange","ngModel"],["matButton","filled",3,"click","disabled"],[1,"search-todo"],[1,"todos-lists"],[1,"todos-active"],[1,"todos-completed"],[3,"todo"]],template:function(e,t){e&1&&(ja(0,"section",0)(1,"div",1)(2,"h2",2),HT(3),QT(4,"date"),nf(),ja(5,"a",3)(6,"mat-icon"),HT(7,"undo"),nf(),HT(8," \u0412\u0435\u0440\u043D\u0443\u0442\u044C\u0441\u044F \u043D\u0430 \u0433\u043B\u0430\u0432\u043D\u0443\u044E "),nf()(),ja(9,"div",4)(10,"div",5)(11,"mat-form-field",6)(12,"mat-label"),HT(13,"\u041D\u043E\u0432\u0430\u044F \u0437\u0430\u0434\u0430\u0447\u0430"),nf(),ja(14,"input",7),ly("ngModelChange",function(o){return GT(t.newTodo,o)||(t.newTodo=o),o}),nf(),Gb(),nf(),ja(15,"button",8),ec("click",function(){return t.addTodo()}),ja(16,"mat-icon"),HT(17,"add"),nf(),HT(18," \u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C "),nf()(),ja(19,"div",9)(20,"mat-form-field",6)(21,"mat-label"),HT(22,"\u041D\u0430\u0439\u0442\u0438 \u0437\u0430\u0434\u0430\u0447\u0443"),nf(),ja(23,"input",7),ly("ngModelChange",function(o){return GT(t.searchTodo,o)||(t.searchTodo=o),o}),nf(),Gb(),nf()()(),ja(24,"div",10)(25,"h3"),HT(26,"\u0410\u043A\u0442\u0438\u0432\u043D\u044B\u0435 \u0437\u0430\u0434\u0430\u0447\u0438"),nf(),ja(27,"div",11),tT(28,Rt,1,1,null,null,JC,false,Nt,2,0,"span"),nf(),ja(31,"h3"),HT(32,"\u0412\u044B\u043F\u043E\u043B\u043D\u0435\u043D\u043D\u044B\u0435 \u0437\u0430\u0434\u0430\u0447\u0438"),nf(),ja(33,"div",12),tT(34,zt,1,1,null,null,JC,false,Pt,1,0),nf()()()),e&2&&(nb(3),af("\u0417\u0430\u0434\u0430\u0447\u0438 \u043D\u0430 ",JT(4,7,t.currentDate,"d.MM.yyyy")),nb(2),Gv("routerLink",t.routesList.main.getLink()),nb(9),uy("ngModel",t.newTodo),qb(),nb(),Gv("disabled",!t.newTodo()),nb(8),uy("ngModel",t.searchTodo),qb(),nb(5),nT(t.todos()),nb(6),nT(t.todos()));},dependencies:[se,it,re,rt$1,$n,Ho,Ar,Wt,Vr,hn,cE,oM],styles:[".todos[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:16px;padding:32px;border-radius:var(--mat-sys-corner-medium);background-color:var(--mat-sys-primary-container);color:var(--mat-sys-on-primary-container)}.todos-header[_ngcontent-%COMP%]{display:flex;justify-content:center;align-items:center;padding:16px;position:relative}.todos-controls[_ngcontent-%COMP%]{display:flex;justify-content:space-between}.create-todo[_ngcontent-%COMP%]{display:flex;gap:24px;align-items:center}.todo-input[_ngcontent-%COMP%]{width:400px}.todos-lists[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:16px}.todos-active[_ngcontent-%COMP%], .todos-completed[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:8px}.back-link[_ngcontent-%COMP%]{position:absolute;right:0}"]})};var pt=class c{static \u0275fac=function(e){return new(e||c)};static \u0275cmp=Zt({type:c,selectors:[["app-todo-page"]],decls:1,vars:0,template:function(e,t){e&1&&Ja(0,"app-todos");},dependencies:[de],encapsulation:2})};export{pt as TodoPage};